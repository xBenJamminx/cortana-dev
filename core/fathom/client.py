...
Usage:
    python3 core/fathom/client.py meetings [--limit N]
    python3 core/fathom/client.py transcript <recording_id>
    python3 core/fathom/client.py summary <recording_id>
    python3 core/fathom/client.py meeting <recording_id>          # full meeting with transcript + summary + actions
    python3 core/fathom/client.py today                            # today's meetings
    python3 core/fathom/client.py search <query>                   # search meeting titles
"""
