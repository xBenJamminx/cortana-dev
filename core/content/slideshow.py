...
# Image generation now lives in core.content.imagegen — re-export for backwards compat
from core.content.imagegen import generate_image_gemini, generate_image, _get_openai_key, _get_gemini_key
